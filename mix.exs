defmodule Scry.Engine.Ch.MixProject do
  use Mix.Project
  ...
  defp description do
    "A real, kind-independent Scry.Core.EngineBehaviour implementation over ClickHouse via " <>
      "ch -- a single authoritative execute/3 compiling WHERE/GROUP BY/aggregates/ORDER BY/" <>
      "DISTINCT/LIMIT/OFFSET into one native SQL statement."
  end

  defp package do
    [
      licenses: ["MIT"],
      links: %{"GitHub" => "https://github.com/joetjen/scry_engine_ch"},
  ...
  defp docs do
    [
      main: "readme",
      source_url: "https://github.com/joetjen/scry_engine_ch",
